...
# -*- coding: utf-8 -*-
"""
真正的批量发送：10条一批发送给LLM，LLM为每条发言单独分析
"""
...
def rebuild_knowledge_base_true_batch(batch_size=10, max_retries=3):
...
if __name__ == "__main__":
    rebuild_knowledge_base_true_batch(batch_size=10, max_retries=2)