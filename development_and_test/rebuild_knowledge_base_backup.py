...
def rebuild_knowledge_base_backup_only():
    """只使用备用API的批量发送"""
    print("="*60)
    print("批量发送知识库构建（20条一批，备用API）")
    print("="*60)
    ...
    # 5. 强制使用备用API
    print("[5/6] 按批次发送LLM分析（强制使用备用API）...")
    print("-" * 60)
...
if __name__ == "__main__":
    rebuild_knowledge_base_backup_only()