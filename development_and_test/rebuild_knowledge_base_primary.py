...
# -*- coding: utf-8 -*-
"""
批量发送：20条一批，使用主API (gemini-2.5-pro-maxthinking)
"""
...
def rebuild_knowledge_base_primary():
    """使用主API的批量发送"""
    print("="*60)
    print("批量发送知识库构建（20条一批，主API）")
    print("="*60)
...
if __name__ == "__main__":
    rebuild_knowledge_base_primary()